...
class Router
{
    private static $views = ['connection', 'connect-user', 'search', 'disconnect-user', 'registration', 'new-user', 'create-announce', 'new-announce', 'user-account', 'update-user', 'update-password', 'user-announces'];
